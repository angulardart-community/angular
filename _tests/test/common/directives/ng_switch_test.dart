...
void main() {
  group('ngSwitch', () {
    ...
    test('should switch among when-values with fallback to default', () async {
      var testBed = NgTestBed<SwitchDefaultTest>(ng.createSwitchDefaultTestFactory());
      var testFixture = await testBed.create();
    ...
    test('should support multiple whens with the same value', () async {
      var testBed = NgTestBed<SwitchMultipleWhenTest>(ng.createSwitchMultipleWhenTestFactory());
      var testFixture = await testBed.create();
    ...
    test('should change after when-values change', () async {
      var testBed = NgTestBed<SwitchWhenValueTest>(ng.createSwitchWhenValueTestFactory());
      var testFixture = await testBed.create();
    ...
    test('should match equal, but not identical, string cases', () async {
      final testBed = NgTestBed<SwitchEqualStringsTest>(ng.createSwitchEqualStringsTestFactory());
