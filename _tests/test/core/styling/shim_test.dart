...
void main() {
  group('host styling', () {
    ...
    test('should apply host style', () async {
      var testBed = NgTestBed<HostStyleTestComponent>(ng.createHostStyleTestComponentFactory());
    ...
    test('should apply host style to nested components', () async {
      var testBed = NgTestBed<HostStyleContainerComponent>(ng.createHostStyleContainerComponentFactory());
      var testFixture = await testBed.create();
    ...
    test('should apply style to element under host', () async {
      var testBed =
          NgTestBed<HostElementSelectorTestComponent>(ng.createHostElementSelectorTestComponentFactory());
      var testFixture = await testBed.create();
    ...
    test('should apply style using element selector', () async {
      var testBed = NgTestBed<ElementSelectorTestComponent>(ng.createElementSelectorTestComponentFactory());
      var testFixture = await testBed.create();
      var elm = testFixture.rootElement.querySelector('div')!;
    ...
    test('should apply style using element selector in nested components',
        () async {
      var testBed = NgTestBed<ContentSelectorTestComponent>(ng.createContentSelectorTestComponentFactory());
      var testFixture = await testBed.create();
    ...
    test('host selector should not override class binding on host', () async {
      var testBed = NgTestBed<ClassOnHostTestComponent>(ng.createClassOnHostTestComponentFactory());
      var testFixture = await testBed.create();
      var elm = testFixture.rootElement;
    ...
    test('should support [attr.class] bindings', () async {
      var testBed = NgTestBed<ClassAttribBindingComponent>(ng.createClassAttribBindingComponentFactory());
      var testFixture = await testBed.create();
    ...
    test('should support class interpolation', () async {
      var testBed = NgTestBed<ClassInterpolateComponent>(ng.createClassInterpolateComponentFactory());
      var testFixture = await testBed.create();
      var elm = testFixture.rootElement.querySelector('#item1')!;
    ...
    test(
      ...
      var testBed =
          NgTestBed<ComponentContainerTestComponent>(ng.createComponentContainerTestComponentFactory());
      var testFixture = await testBed.create();
    ...
    test('Should apply shim class on top of host attr.class property',
        () async {
      var testBed = NgTestBed<NgHostAttribShimTest>(ng.createNgHostAttribShimTestFactory());
      var testFixture = await testBed.create();
    ...
    test('Should shim svg elements with no compile type errors', () async {
      var testBed = NgTestBed<SvgComponentTest>(ng.createSvgComponentTestFactory());
      await testBed.create();
    });

    test('Should support class binding to host component', () async {
      var testBed = NgTestBed<FeaturePromoComponent2>(ng.createFeaturePromoComponent2Factory());
      var testFixture = await testBed.create();
      var elm = testFixture.rootElement;
