...
void main() {
  ...
  test('should render message in attribute', () async {
    final testBed = NgTestBed<TestI18nAttribute>(ng.createTestI18nAttributeFactory());
    final testFixture = await testBed.create();
    final imgElement =
  ...
  test('should render message with HTML', () async {
    final testBed = NgTestBed<TestI18nNodeWithHtml>(ng.createTestI18nNodeWithHtmlFactory());
    final testFixture = await testBed.create();
  ...
  test('should render message with unsafe HTML', () async {
    final testBed = NgTestBed<TestI18nNodeWithUnsafeHtml>(ng.createTestI18nNodeWithUnsafeHtmlFactory());
    final testFixture = await testBed.create();
  ...
  test('should render message with escaped HTML characters', () async {
    final testBed =
        NgTestBed<TestI18nNodeWithEscapedHtmlCharacters>(ng.createTestI18nNodeWithEscapedHtmlCharactersFactory());
    final testFixture = await testBed.create();
    expect(testFixture.text, 'Not <i>italic</i>.');
  });

  test('should render message with HTML and escaped HTML characters', () async {
    final testBed = NgTestBed<TestI18nNodeWithHtmlAndEscapedHtmlCharacters>(ng.createTestI18nNodeWithHtmlAndEscapedHtmlCharactersFactory());
    final testFixture = await testBed.create();
  ...
  test('should render message with i18n parameters', () async {
    final testBed = NgTestBed<TestI18nParameters>(ng.createTestI18nParametersFactory());
    final testFixture = await testBed.create();
  ...
  test('should render a message from a template', () async {
    final testBed = NgTestBed<TestI18nTemplate>(ng.createTestI18nTemplateFactory());
    final testFixture = await testBed.create();
  ...
  test('should inject an i18n attribute', () async {
    final testBed = NgTestBed<TestInjectI18nAttribute>(ng.createTestInjectI18nAttributeFactory());
    final testFixture = await testBed.create();
  ...
  group('should set internationalized property', () {
    test('explicitly', () async {
      final testBed = NgTestBed<TestExplicitI18nInput>(ng.createTestExplicitI18nInputFactory());
      final testFixture = await testBed.create();
    ...
    test('implicitly', () async {
      final testBed = NgTestBed<TestImplicitI18nInput>(ng.createTestImplicitI18nInputFactory());
      final testFixture = await testBed.create();
      expect(testFixture.assertOnlyInstance.greeting!.message,
          'An internationalized property');
    });
  ...
  test('should support internationalized property on <template>', () async {
    final testBed = NgTestBed<TestI18nInputOnTemplate>(ng.createTestI18nInputOnTemplateFactory());
    final testFixture = await testBed.create();
