...
void main() {
  group('projection', () {
    ...
    test(
      ...
      var testBed = NgTestBed<NonBoundInterpolationTest>(ng.createNonBoundInterpolationTestFactory());
    ...
    test('should project content components', () async {
      var testBed = NgTestBed<ProjectComponentTest>(ng.createProjectComponentTestFactory());
      var fixture = await testBed.create();
    ...
    test('should support multiple content tags', () async {
      var testBed = NgTestBed<MultipleContentTagsTest>(ng.createMultipleContentTagsTestFactory());
      var fixture = await testBed.create();
      expect(fixture.text, '(A, BC)');
    });
    test('should redistribute only direct children', () async {
      var testBed = NgTestBed<OnlyDirectChildrenTest>(ng.createOnlyDirectChildrenTestFactory());
      var fixture = await testBed.create();
    ...
    test(
      ...
      var testBed = NgTestBed<LightDomChangeTest>(ng.createLightDomChangeTestFactory());
      var fixture = await testBed.create();
    ...
    test('should support nested components', () async {
      var testBed = NgTestBed<NestedComponentTest>(ng.createNestedComponentTestFactory());
      var fixture = await testBed.create();
    ...
    test(
      ...
      var testBed = NgTestBed<NestedDirectChildTest>(ng.createNestedDirectChildTestFactory());
      var fixture = await testBed.create();
    ...
    test('should redistribute when the shadow dom changes', () async {
      var testBed = NgTestBed<ShadowDomChangeTest>(ng.createShadowDomChangeTestFactory());
      var fixture = await testBed.create();
    ...
    test('should support text nodes after content tags', () async {
      var testBed = NgTestBed<TextNodeAfterContentTest>(ng.createTextNodeAfterContentTestFactory());
      var fixture = await testBed.create();
      expect(fixture.text, 'P,text');
    });
    test('should support text nodes after style tags', () async {
      var testBed = NgTestBed<TextNodeAfterStyleTest>(ng.createTextNodeAfterStyleTestFactory());
      var fixture = await testBed.create();
      expect(fixture.text, 'P,text');
    });
    test('should support moving non projected light dom around', () async {
      var testBed = NgTestBed<MoveLightDomTest>(ng.createMoveLightDomTestFactory());
      var fixture = await testBed.create();
    ...
    test('should support moving project light dom around', () async {
      var testBed = NgTestBed<MoveProjectedLightDomTest>(ng.createMoveProjectedLightDomTestFactory());
      var fixture = await testBed.create();
    ...
    test('should support moving ng-content around', () async {
      var testBed = NgTestBed<MoveNgContentTest>(ng.createMoveNgContentTestFactory());
      var fixture = await testBed.create();
    ...
    test('should still allow to implement recursive trees', () async {
      var testBed = NgTestBed<RecursiveTreeTest>(ng.createRecursiveTreeTestFactory());
      var fixture = await testBed.create();
    ...
    test(
      ...
      var testBed =
          NgTestBed<RecursiveTreeMultipleComponentTest>(ng.createRecursiveTreeMultipleComponentTestFactory());
      var fixture = await testBed.create();
      expect(fixture.text, 'TREE(0:)');
    ...
    test('should support nested conditionals that contain ng-contents',
        () async {
      var testBed = NgTestBed<NestedConditionalTest>(ng.createNestedConditionalTestFactory());
      var fixture = await testBed.create();
    ...
    test('should allow to switch the order of nested components via ng-content',
        () async {
      var testBed = NgTestBed<SwitchOrderTest>(ng.createSwitchOrderTestFactory());
      var fixture = await testBed.create();
      expect(
    ...
    test('should create nested components in the right order', () async {
      var testBed = NgTestBed<CorrectOrderTest>(ng.createCorrectOrderTestFactory());
      var fixture = await testBed.create();
      expect(
          fixture.rootElement.innerHtml,
    ...
    test('should project filled view containers into a view container',
        () async {
      var testBed = NgTestBed<NestedProjectionTest>(ng.createNestedProjectionTestFactory());
      var fixture = await testBed.create();
    ...
    test('should support <ng-content> as root of an embedded view', () async {
      final testBed = NgTestBed<TestNgIfNgContent>(ng.createTestNgIfNgContentFactory());
