...
void main() {
  ...
  group('components', () {
    test('should support a single concrete type argument', () async {
      final testBed =
          NgTestBed<TestSingleConcreteTypeArgument>(ng.createTestSingleConcreteTypeArgumentFactory());
    ...
    test('should support multiple concrete type arguments', () async {
      final testBed =
          NgTestBed<TestMultipleConcreteTypeArgument>(ng.createTestMultipleConcreteTypeArgumentFactory());
      final testFixture = await testBed.create();
      expect(testFixture.assertOnlyInstance.child,
    ...
    test('should support a nested concrete type argument', () async {
      final testBed =
          NgTestBed<TestNestedConcreteTypeArgument>(ng.createTestNestedConcreteTypeArgumentFactory());
      final testFixture = await testBed.create();
      expect(testFixture.assertOnlyInstance.child,
    ...
    test('should flow a type argument', () async {
      final testBed = NgTestBed<TestFlowTypeArgument>(ng.createTestFlowTypeArgumentFactory());
      final testFixture = await testBed.create();
      expect(testFixture.assertOnlyInstance.child,
    ...
    test('should distinctly type unique instances of same component', () async {
      final testBed =
          NgTestBed<TestDistinctlyTypedDirectives>(ng.createTestDistinctlyTypedDirectivesFactory());
      final testFixture = await testBed.create();
    ...
    test('should instantiate to bounds', () async {
      final testBed = NgTestBed<TestBoundedGenericComponent>(ng.createTestBoundedGenericComponentFactory());
      final testFixture = await testBed.create();
      expect(testFixture.assertOnlyInstance.child,
  ...
  group('component factories', () {
    test('should support a single type argument', () async {
      final testBed =
          NgTestBed<SingleGenericComponent>(ng.createSingleGenericComponentFactory<String>());
      final testFixture = await testBed.create();
    ...
    test('should support multiple type arguments', () async {
      final testBed =
          NgTestBed<MultipleGenericComponent>(ng.createMultipleGenericComponentFactory<String, int>());
      final testFixture = await testBed.create();
      expect(testFixture.assertOnlyInstance,
          const TypeMatcher<MultipleGenericComponent<String, int>>());
    });
    ...
    test('should instantiate to bounds', () async {
      final testBed = NgTestBed<BoundedGenericComponent>(ng.createBoundedGenericComponentFactory());
      final testFixture = await testBed.create();
      expect(testFixture.assertOnlyInstance,
          const TypeMatcher<BoundedGenericComponent<Bound>>());
    });
  ...
  group('directives', () {
    test('should support generics', () async {
      final testBed = NgTestBed<TestGenericDirective>(ng.createTestGenericDirectiveFactory());
      final testFixture = await testBed.create();
    ...
    test('with a change detector host should support generics', () async {
      final testBed =
          NgTestBed<TestGenericDirectiveWithChangeDetector>(ng.createTestGenericDirectiveWithChangeDetectorFactory());
      final testFixture = await testBed.create();
      expect(testFixture.assertOnlyInstance.directive,
    ...
    test('should instantiate to bounds', () async {
      final testBed = NgTestBed<TestBoundedGenericDirectiveWithChangeDetector>(ng.createTestBoundedGenericDirectiveWithChangeDetectorFactory());
      final testFixture = await testBed.create();
      expect(
  ...
  test('generic function member should return normally', () async {
    final testBed = NgTestBed<TestFunctionComponent>(ng.createTestFunctionComponentFactory());
    final testFixture = await testBed.create();
